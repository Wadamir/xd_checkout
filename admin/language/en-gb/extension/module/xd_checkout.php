...
$_['text_upload_cities_no_rows_for_selected_countries'] = 'No cities for selected countries were found in the local file.';
$_['text_upload_cities_no_rows_api_start']      = 'No cities for the selected country were found in the local file.';
$_['text_upload_cities_no_rows_short']          = 'No cities for the selected country were found in the local file.';
$_['text_upload_cities_no_rows_recommend_api']  = 'No cities for the selected country were found in the local file. I recommend updating from API: enable the checkbox and run the update again.';
