...
class ControllerCheckoutXdCheckoutGuest extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($fields_address as $key => $field) {
            ...
            // $sort_order[$key + 10] = $field_data['sort_order'];
        }

        // array_multisort($sort_order, SORT_ASC, $fields);

        // var_dump($data['fields_personal']);
        // var_dump($data['fields_address']);
