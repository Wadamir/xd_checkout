...
class ControllerExtensionXdCheckoutShippingMethod extends Controller
{
    ...
    public function index()
    {
        ...
        $data['delivery'] = isset($xd_checkout_settings['delivery']) ? $xd_checkout_settings['delivery'] : 0;
        $data['delivery_delivery_time'] = isset($xd_checkout_settings['delivery_time']) ? $xd_checkout_settings['delivery_time'] : 0;
        $data['delivery_required'] = isset($xd_checkout_settings['delivery_required']) ? $xd_checkout_settings['delivery_required'] : 0;
        $data['delivery_times'] = isset($xd_checkout_settings['delivery_times']) ? $xd_checkout_settings['delivery_times'] : [];
        ...
        $data['cart'] = isset($xd_checkout_settings['cart']) ? $xd_checkout_settings['cart'] : 0;
        $data['shipping_reload'] = isset($xd_checkout_settings['shipping_reload']) ? $xd_checkout_settings['shipping_reload'] : 0;
