<?php
class ControllerExtensionXdCheckoutGuestShipping extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($fields as $key => $field) {
            $field_data = $this->xd_checkout_settings['field_' . $field];
        ...
        $this->response->setOutput($this->load->view('extension/xd_checkout/guest_shipping', $data));
    }
    ...
    public function validate()
    {
        ...
        if (!$json) {
            $firstname = $this->xd_checkout_settings['field_firstname'];
            ...
            $lastname = $this->xd_checkout_settings['field_lastname'];
            ...
            $address_1 = $this->xd_checkout_settings['field_address_1'];
            ...
            $address_2 = $this->xd_checkout_settings['field_address_2'];
            ...
            $city = $this->xd_checkout_settings['field_city'];
            ...
            $company = $this->xd_checkout_settings['field_company'];
